...
export const PATTERN_RULES: PatternRule[] = [
  ...
  // Prompt injection
  {
    patterns: [
      ...
      // Polish prompt injection
      /wy[łl]([aą])cz\s+(filtry|zabezpieczenia|bezpiecze[nń]stwo|ochron[eę]|zasady|regu[łl]y)/i,
      /zignoruj\s+(wszystkie\s+)?(instrukcje|zasady|filtry|regu[łl]y|polecenia|ograniczenia)/i,
      /ignoruj\s+(wszystkie\s+)?(instrukcje|zasady|filtry|regu[łl]y|polecenia|ograniczenia)/i,
      /usu[nń]\s+(filtry|zabezpieczenia|ograniczenia|zasady|regu[łl]y)/i,
      /wy[łl]([aą])cz\s+(si[eę]|wszystko)/i,
      /olej\s+(filtry|zasady|regu[łl]y|instrukcje|zabezpieczenia)/i,
      /bez\s+(filtr[oó]w|zabezpiecze[nń]|ogranicze[nń]|zasad|regu[łl])/i,
      /zdejmij\s+(filtry|zabezpieczenia|ograniczenia|blokady)/i,
      /od[bł]lokuj\s+(wszystko|filtry|tryb|pe[łl]ny)/i,
      ...
      /nie\s+(filtruj|blokuj|cenzuruj)/i,
